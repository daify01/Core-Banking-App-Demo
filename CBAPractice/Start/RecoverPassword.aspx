...
<html>
  <head>
    ...
    <title>Core Banking App | Recover Password</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Enter Required Details to Recieve New Password</p>
        <form id="form1" runat="server" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="text" runat="server" class="form-control" id="TextBoxNameEmail" placeholder="Email" required="required"/>
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="row">            
            <div class="col-xs-4">
             <button id="Button1" type="submit" runat="server" OnServerClick="searchsubmit_OnServerClick" class="btn btn-primary">Recover Password</button>
            </div><!-- /.col -->
          </div>
        </form>
