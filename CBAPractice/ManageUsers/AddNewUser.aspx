<%@ Page Title="" Language="C#" MasterPageFile="~/CBA.Master" AutoEventWireup="true" CodeBehind="AddNewUser.aspx.cs" Inherits="CBAPractice.ManageUsers.AddNewUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <input type="text" runat="server" class="form-control" id="TextBoxNameONames" title="OtherName" maxlength="20" placeholder="Enter Name"/>
                            ...
                            <div class="form-group">
                               ...
                               <asp:DropDownList ID="BranchDropDown" class="form-group" runat="server" ClientIDMode="Static" required="required" AppendDataBoundItems="True"  CssClass="form-control" DataTextField="BranchName" DataValueField="Id">
                                   <asp:ListItem/>
                               </asp:DropDownList>
                            </div>
                                </div>
    ...
    <!-- /.content -->
     <script type="text/javascript">
         $(function () {
             $('#BranchDropDown').select2({ placeholder: "Please Select A Branch" }),
